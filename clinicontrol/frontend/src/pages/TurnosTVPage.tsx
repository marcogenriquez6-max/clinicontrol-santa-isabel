...
export default function TurnosTVPage() {
  ...
  const tvContent = (
    <div className={`rounded-2xl overflow-hidden border border-[var(--border-primary)] shadow-xl ${
      ...
      <div className={`flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 p-6 lg:p-10 ${fullscreen ? 'overflow-y-auto' : ''}`}>
        ...
        {config.mostrarEspera && (
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[var(--warning-100)]">
        ...
        <div className="space-y-6 lg:space-y-8">
          ...
          {config.mostrarAtencion && (
            <div>
              ...
              {turnosAtencion.length > 0 ? (
                ...
                <div className="p-6 lg:p-8 bg-[var(--bg-secondary)] rounded-2xl border-2 border-dashed border-[var(--border-primary)] text-center">
            ...
            <div>
              ...
              <div className="space-y-2 lg:space-y-3">
                {turnosLlamados.slice(0, config.maxTurnosLlamados).map(t => (
                  <div key={t.id || t.numero}
                    className="flex items-center gap-4 p-4 lg:p-5 bg-[var(--info-50)] rounded-xl border border-[var(--info-200)]"
                  >
          ...
          {config.mostrarLeyenda && (
            <div className={`flex items-center justify-center gap-6 p-4 bg-[var(--bg-secondary)] rounded-xl border border-[var(--border-primary)] ${fullscreen ? 'text-base' : 'text-xs'} text-[var(--text-tertiary)]`}>
