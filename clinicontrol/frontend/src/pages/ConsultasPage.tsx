    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="h-48 rounded-2xl animate-pulse" style={{ backgroundColor: 'var(--bg-secondary)' }} />
          ))}
        </div>
      ) : (
        <>
          ...
          <section>
            ...
            {filteredEnAtencion.length === 0 ? (
              <div className="rounded-2xl border border-dashed p-6 text-center text-sm" style={{ borderColor: 'var(--border-primary)', color: 'var(--text-tertiary)' }}>
          ...
          <section className="pt-2">
            ...
            {filteredPendientes.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center rounded-2xl border border-dashed" style={{ borderColor: 'var(--border-primary)' }}>
